...
$(document).on('click', '.fa-shopping-cart', function (e) {
  ...
  if (existingCartItem) {
    ...
    // $.post("http://qb-shop/setCart", JSON.stringify({
    //   type: type,
    //   price: price,
    //   image: image,
    //   id: id,
    ...
    $.each(data, function (i, v) {
      ...
      <div class="item">
        ...
        <div class="itemalt">
          ...
          <div class="cartbox">
            <i data-name="${v.name}" data-id="${i}" data-image="${v.image}" data-type="${v.type}" data-price="${v.price}" class="fas fa-shopping-cart"></i>
          </div>
        </div>
...
function openMenu(data){
  var keys = Object.keys(data.marketItemList);
  var firstKey = keys[0];
  var firstData = data.marketItemList[firstKey];
